public class Grasshopper extends Grass
{
    public Grasshopper(){
		organismChar = 'G';
		foodChainLevel = 1; //organisms in level 1 eat level 0 organisms, and are eaten by higher level organisms
		carnivorousType = false;
    }
	...
	switch (generateXCoord){
		...
		System.out.println("\nThe coordinates of the grasshopper are: X: " + generateXCoord + ", Y: " + generateYCoord + ".");
    }
}
